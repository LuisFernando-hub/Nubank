  ...
  <q-page class="column justify-center items-center">
    ...
    <q-card class="my-card q-ma-lg" flat bordered>
      <q-card-section horizontal class="q-pa-lg">
        ...
        <q-card-action vertical class="column justify-center">
      ...
      >
        ...
        <span class="q-mx-sm"
          >Compra mais recente em cantina Nero no valor de R$ 84,00 hoje</span
        >
    ...
    <q-scroll-area horizontal class="q-ml-md q-my-md">
      <div class="row no-wrap">
        <q-card class="card-items column justify-betwenn q-ml-sm">
          <q-card-section>
